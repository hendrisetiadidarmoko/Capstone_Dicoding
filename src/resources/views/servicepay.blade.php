    ...
    <section class="vh-100">
        <div class="container h-100">
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                background: #F3F0F0;">
                        <div class="card-servic card-body " id="content-edugot">
                            <form method="POST" action="{{ route('home') }}" enctype="multipart/form-data">
                                ...
                                <div class="row color-service my-3 py-3">
                                    ...
                                    <div class="col-2">
                                        <img  src="{{ asset('../assets/image/mandiri.png') }}" alt="mandiri">
                                ...
                                @endif
                                <button type="submit" class="btn buyMaggot  w-100 my-4 fw-bold">Selesai</button>
