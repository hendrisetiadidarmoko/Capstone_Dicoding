...
@section('content')
    <section>
        <div class="container mt-4 ">
            <h2 class="fw-bold text-center mb-4" id="content-edugot" >Visi & Misi</h2>
            <div class="row">
                ...
                <div class='trapesium position-absolute text-center'>
                    <div class="p-1 d-flex flex-column align-items-center">
                        ...
                        <div class="w-100 d-flex justify-content-center">
                            <div class="btn-link ">
                                <a href="{{ route('checkout') }}" class="btn p-1 fw-bold ">Beli Sekarang</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class=" row g-5 align-items-center mx-1 justify-content-center">
                    <div class="col-12 col-xl-4 col-md-6 col-sm-10">
                        <div class="card rounded bg-body-secondary equal-height-card">
                            <img src="{{ asset('../assets/team-image/Annastia Reza D.jpg') }}" class="card-img-top  pt-3 px-5" alt="..."
                                style="height: 20rem;">
                    ...
                    <div class="col-12 col-xl-4 col-md-6 col-sm-10">
                        <div class="card rounded bg-body-secondary equal-height-card">
                            <img src="{{ asset('../assets/team-image/hendri.jpg') }}" class="card-img-top  pt-3 px-5" alt="..."
                                style="height: 20rem;">
                            <div class="card-body">
                    ...
                    <div class="col-12 col-xl-4  col-md-6 col-sm-10">
                        <div class="card rounded bg-body-secondary equal-height-card">
                            <img src="{{ asset('../assets/team-image/vincent.jpg') }}" class="card-img-top  pt-3 px-5" alt="..."
                                style="height: 20rem;">
                            <div class="card-body">
                    ...
                    <div class="col-12 col-xl-4 col-md-6 col-sm-10">
                        <div class="card rounded bg-body-secondary equal-height-card">
                            <img src="{{ asset('../assets/team-image/lff.jpg') }} " class="card-img-team card-img-top  pt-3 px-5" alt="..."
                                style="height: 20rem;">
                            <div class="card-body">
