...
Route::get('/layanan', [ProductController::class, 'showProduct'])->name('layanan');
...
Route::post('/order-complete', [OrderController::class, 'changeOrderStatus' ])->name('completeOrder');
