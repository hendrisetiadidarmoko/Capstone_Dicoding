    ...
    <section>
        <div class="container h-100">
            <div class="card border-0">
                <h1 class="card-title text-center mt-3 fw-bold">{{ $article->title }}</h1>
                <div class="row d-flex h-100">
                    <div class="col-12 col-xl-8  col-sm-7 mt-3">
                        <div class="card border-0">
                            <div class="card-body card-blog">
                                <img src="{{ asset($article->url_img) }}" alt="" class="w-100   mb-5">
                        ...
                        <div class="card ">
                            <div class="card-body card-blog p-0">
                                ...
                                <div class="p-3">
                                    ...
                                    <h5 class="card-text fw-semibold">Sumber</h5>
