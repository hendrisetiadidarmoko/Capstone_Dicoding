                    ...
                    <div class="card p-2" style="border-radius: 10px;
                        ...
                        <div class="card-register card-body ">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="username input-group-text bg-light">
                                    <span class="input-group-text bg-light" style="border: none;" id="username-addon">
                                        <i class="fas fa-user"></i>
                                    </span>
                                    <input type="text" class="form-control rounded" style="border: none;"
                                        id="usernameInput" placeholder="Username" aria-label="Username"
                            ...
                            <p class="card-text text-center">Don't have an account yet?<span><a href=""
